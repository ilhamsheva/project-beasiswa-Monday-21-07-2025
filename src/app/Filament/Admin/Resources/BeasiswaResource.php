        ...
        return $form
            ->schema([
                ...
                Forms\Components\Textarea::make('deskripsi')
                    ->columnSpanFull(),
                Forms\Components\DatePicker::make('periode_buka')
                    ->required(),
                Forms\Components\DatePicker::make('periode_tutup')
                    ->required(),
        ...
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('nama_beasiswa')
                    ->searchable(),
                Tables\Columns\TextColumn::make('periode_buka')
                    ->date()
                    ->sortable(),
                Tables\Columns\TextColumn::make('periode_tutup')
                    ->date()
                    ->sortable(),
